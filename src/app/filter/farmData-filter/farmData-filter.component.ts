...
@Component({
  selector: 'farmData-filter',
  templateUrl: './farmData-filter.component.html',
  styleUrls: ['./farmData-filter.component.scss'],
})

export class FarmDataFilterComponent implements OnInit {
